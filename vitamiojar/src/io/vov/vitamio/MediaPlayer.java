...
public class MediaPlayer {
  ...
  private class EventHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      Log.e("视频播放的处理1： " + msg.what+"===="+msg.arg1+"===="+msg.arg2+"-----"+isBuffering());
      switch (msg.what) {
        ...
        case MEDIA_BUFFERING_UPDATE://3
          ...
          return;
        case MEDIA_SEEK_COMPLETE://4
          if (isPlaying())
            stayAwake(true);
          if (mOnSeekCompleteListener != null)
            mOnSeekCompleteListener.onSeekComplete(mMediaPlayer);
          return;
        case MEDIA_SET_VIDEO_SIZE://5
        ...
        case MEDIA_INFO://200
          ...
          if (msg.arg1 == MediaPlayer.MEDIA_INFO_BUFFERING_END) {//缓存结束
            if (mOnBufferingUpdateListener != null)
              mOnBufferingUpdateListener.onBufferingUpdate(mMediaPlayer, 100);
          }
          return;
        case MEDIA_CACHE://300
          return;
        case MEDIA_TIMED_TEXT://1000
          mData = msg.getData();
          ...
          return;
        case MEDIA_CACHING_UPDATE://2000
